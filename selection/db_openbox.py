...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        config_list = []
        config_list.append([(0, 2), (2, 5), (5, 6), (6, 11), (11, 13), (13, 14), (14, 15), (15, 16), (16, 18), (18, 19), (19, 20)],)
        config_list += [177027, 145712, 417145, 443187, 313778, 121025, 37333, 105602, 166449, 336659, 352201, 157352, 268616, 249928, 40433, 304166, 432335, 480939, 18803, 422406]
